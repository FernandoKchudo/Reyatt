...
-- // ORBIT CHARACTER - Abyss Library Edition
...
-- ==================== ABYSS LIBRARY (Tu librería) ==================== --
-- (Aquí va toda tu librería que me pasaste)
-- ... [Pega toda la librería que me diste aquí] ...

-- (Como la librería es muy larga, asumo que ya la tienes arriba. Si no, avísame y te la pongo completa)

-- ==================== ORBIT MENU ==================== --
local window = Library.Window("Orbit Character", Vector2.new(520, 620))

local mainTab = window:Tab("Main")
local settingsTab = window:Tab("Settings")

-- Main Tab
local control = mainTab:Section("Control", "Left")
...
-- Settings Tab
local orbitSettings = settingsTab:Section("Orbit Settings", "Left")

orbitSettings:Slider({
    Title = "Distancia",
    Min = 8,
    Max = 30,
    Default = 16,
...
orbitSettings:Slider({
    ...
    Max = 25,
    Default = 7,
    Callback = function(v) settings.Height = v end
})
...
print("✅ Orbit con Abyss Library cargado | Presiona O")
